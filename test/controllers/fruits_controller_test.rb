...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference("Fruit.count") do
      post fruits_url, params: { fruit: { family: @fruit.family, genus: @fruit.genus, name: @fruit.name, nutritions: @fruit.nutritions, order: @fruit.order } }
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { family: @fruit.family, genus: @fruit.genus, name: @fruit.name, nutritions: @fruit.nutritions, order: @fruit.order } }
